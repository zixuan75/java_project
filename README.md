...
## Add a comment on the *Beta folder* pull request
...
You can delete a comment when it is solved, except you can solve your problem. It is not possible to delete comments when you have an problem, the *Beta folder* pull request is going be locked conversation.
...
A problem may be an action to applying a commit, and commenting a pull request. On the other hand, it is not possible to apply a commit because we can apply a commit. The problem is close an comment does not make sense. 